...
class BluetoothDeviceAdapter (private val layoutInflater: LayoutInflater) :
    RecyclerView.Adapter<BluetoothDeviceAdapter.DeviceInfoViewHolder>() {
    ...
    inner class DeviceInfoViewHolder(containerView: View) : RecyclerView.ViewHolder(containerView) {
        ...
        fun bind(deviceInfo: DeviceInfo) {
            ipAddressTexView.text = "Device Name: " + deviceInfo.ipAddress
